...
class PipelineContext:
    ...
    Attributes:
        ...
        source_names: Canonical column name to the header this particular file used,
            for columns matched through a synonym. Per-run state, so it lives here
            rather than on the frozen schema, which must not know what one file
            called its columns.
    ...
    def source_name(self, canonical: str) -> str:
        """The header this file used for a column, which is its canonical name unless renamed.
        ...
        """
        return self.source_names.get(canonical, canonical)
